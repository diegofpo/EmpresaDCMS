<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="TicketCompletado.aspx.cs" Inherits="EmpresaDCMS.WebForm10" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border-style: double; width: 850px; text-align: center;" class="pantallaRol">
        <asp:Panel ID="panelTicket" runat="server">
            <asp:GridView ID="gvTicket" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" CssClass="gridview" ForeColor="Black" Width="801px" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Ticket No." DataSourceID="SqlDataSource1">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DCMSConnectionString %>" SelectCommand="SELECT idTicket AS 'Ticket No.', idEmpleado AS 'Solicitante', idTecnico AS 'Tecnico', CONVERT(VARCHAR(11), fechaIngreso,6) AS 'Fecha de Ingreso', CONVERT(VARCHAR(11), fechaSolucion,6) AS 'Fecha de Solucion' FROM Ticket WHERE (estadoTicket = 3)"></asp:SqlDataSource>
            <br />
