<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="TicketActivo.aspx.cs" Inherits="EmpresaDCMS.WebForm7" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border-style: double; width: 850px; text-align: center;" class="pantallaRol">
        <asp:Panel ID="panelTicket" runat="server">
            <asp:GridView ID="gvTicket" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" CssClass="gridview" ForeColor="Black" Width="801px" OnSelectedIndexChanged="gvAsignado_SelectedIndexChanged" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Ticket No." DataSourceID="SqlDataSource2">
                <Columns>
